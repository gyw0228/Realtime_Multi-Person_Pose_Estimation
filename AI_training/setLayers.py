...
def setLayers_twoBranches(data_source, batch_size, layername, kernel, stride, outCH, label_name, transform_param_in, deploy=False, batchnorm=0, lr_mult_distro=[1,1,1]):
    ...
    # produce data definition for deploy net
       ...
       # todo slice_point for [38, num_parts+1, num_parts+39]
...
if __name__ == "__main__":
    ...
    if(exp == 1):
#directory for 
        directory = '/mnt/sda1/yihongwei/dataset/AIChallenger/ai_challenger_exp_caffe/pose40/exp22/'
#serverFolder for store all prototxt
        serverFolder = '/mnt/sda1/yihongwei/dataset/AIChallenger/ai_challenger_kpt_model/pose40/exp22'
#base_folder for store model        
	base_folder = directory+'model'
## dataFolder and source for input lmdb
        dataFolder = '/mnt/sda1/yihongwei/dataset/AIChallenger/ai_challenger_keypoint_train_20170902/AIChallenger_lmdb_20170902'
